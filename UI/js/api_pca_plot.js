...
async function drawPcaPlot() {
    try {
        ...
        const replicateInformation = document.getElementById("pca_replicateInformation").value; // 获取平行样标识
        const replicateMethods = document.getElementById("pca_replicateMethods").value; // 获取平行样处理方法
